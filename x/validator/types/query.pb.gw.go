...
var (
	pattern_Query_Validator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"liubaninc", "m0", "validator", "address"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_ValidatorAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 2}, []string{"liubaninc", "m0", "validator"}, "", runtime.AssumeColonVerbOpt(true)))
