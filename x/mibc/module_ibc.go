...
func (am AppModule) OnRecvPacket(
	...
	var modulePacketData types.MibcPacketData
	...
	case *types.MibcPacketData_IbcUTXOPacket:
		packetAck, err := am.keeper.OnRecvIbcUTXOPacket(ctx, modulePacket, *packet.IbcUTXOPacket)
		if err != nil {
...
func (am AppModule) OnAcknowledgementPacket(
	...
	case *types.MibcPacketData_IbcUTXOPacket:
		err := am.keeper.OnAcknowledgementIbcUTXOPacket(ctx, modulePacket, *packet.IbcUTXOPacket, ack)
		if err != nil {
			return nil, err
		}
		eventType = types.EventTypeIbcUTXOPacket
	default:
		errMsg := fmt.Sprintf("unrecognized %s packet type: %T", types.ModuleName, packet)
...
func (am AppModule) OnTimeoutPacket(
	...
	case *types.MibcPacketData_IbcUTXOPacket:
		err := am.keeper.OnTimeoutIbcUTXOPacket(ctx, modulePacket, *packet.IbcUTXOPacket)
		if err != nil {
			return nil, err
		}
	default:
