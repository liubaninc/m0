...
func (mci *XMCacheIterator) Data() *xmodel.VersionedData {
...
func (mci *XMCacheIterator) data(iter iterator.Iterator) *xmodel.VersionedData {
	val := iter.Value()
