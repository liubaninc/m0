...
func (*NativeCodeDesc) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f736f869784d35d, []int{0}
}
...
func (*WasmCodeDesc) Descriptor() ([]byte, []int) {
	return fileDescriptor_6f736f869784d35d, []int{1}
}
...
func init() { proto.RegisterFile("wasm/code_desc.proto", fileDescriptor_6f736f869784d35d) }

var fileDescriptor_6f736f869784d35d = []byte{
	// 310 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *NativeCodeDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ApiVersion != 0 {
		i = encodeVarintCodeDesc(dAtA, i, uint64(m.ApiVersion))
		i--
		dAtA[i] = 0x28
	}
	if len(m.PrevVersion) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.PrevVersion)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Digest) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.Digest)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Version) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.Version)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *WasmCodeDesc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ContractType) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.ContractType)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.VmCompiler) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.VmCompiler)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Digest) > 0 {
	...
	if len(m.Compiler) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.Compiler)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Runtime) > 0 {
		...
		i = encodeVarintCodeDesc(dAtA, i, uint64(len(m.Runtime)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func encodeVarintCodeDesc(dAtA []byte, offset int, v uint64) int {
	offset -= sovCodeDesc(v)
	base := offset
	for v >= 1<<7 {
...
func (m *NativeCodeDesc) Size() (n int) {
	...
	if m.ApiVersion != 0 {
		n += 1 + sovCodeDesc(uint64(m.ApiVersion))
	}
	return n
}
...
func sovCodeDesc(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozCodeDesc(x uint64) (n int) {
	return sovCodeDesc(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *NativeCodeDesc) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthCodeDesc
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipCodeDesc(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipCodeDesc(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowCodeDesc
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthCodeDesc
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupCodeDesc
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthCodeDesc        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowCodeDesc          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupCodeDesc = fmt.Errorf("proto: unexpected end of group")
)
