#include <inttypes.h>
#include <iostream>
#include "mchain/table/table.h"

namespace mchain { namespace cdt {

template <typename T>
Table<T>::Table(mchain::Context* ctx, const std::string& name)
...
template <typename T>
TableIterator<T>::TableIterator(mchain::Context* ctx, std::string idx)
