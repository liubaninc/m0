...
constexpr size_t mchain_sizeof(T (&arr)[N]) { return N; }

template <typename... Args>
const std::string mchain_concat(Args... args) {
...
#define DEFINE_INDEX_ADD_0(id)                                                          \
        { #id ,                                                                         \
            [&]() -> std::string { return mchain_concat(#id); } },

#define DEFINE_INDEX_ADD_1(id, _1)                                                      \
        { mchain_concat(#_1) ,                                                          \
            [&]() -> std::string { return mchain_concat(#_1, _1()); } },                \
        { #id ,                                                                         \
            [&]() -> std::string { return mchain_concat(#_1); } },

#define DEFINE_INDEX_ADD_2(id, _1, _2)                                                  \
        { mchain_concat(#_1, #_2) ,                                                     \
            [&]() -> std::string { return mchain_concat(#_1, _1(), #_2, _2()); } },     \
        { #id ,                                                                         \
            [&]() -> std::string { return mchain_concat(#_1, #_2); } },

#define DEFINE_INDEX_ADD_3(id, _1, _2, _3)                                              \
        { mchain_concat(#_1, #_2, #_3),                                                 \
            [&]() -> std::string { return mchain_concat(#_1, _1(), #_2, _2(), #_3, _3()); } },\
        { #id ,                                                                         \
            [&]() -> std::string { return mchain_concat(#_1, #_2, #_3); } },

#define DEFINE_INDEX_ADD_4(id, _1, _2, _3, _4)                                          \
        { mchain_concat(#_1, #_2, #_3, #_4),                                            \
            [&]() -> std::string { return mchain_concat(#_1, _1(), #_2, _2(), #_3, _3(), #_4, _4()); } },\
        { #id ,                                                                         \
            [&]() -> std::string { return mchain_concat(#_1, #_2, #_3, #_4); } },
