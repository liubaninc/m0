...
inline ::google::protobuf::int64 QueryBlockRequest::height() const {
  // @@protoc_insertion_point(field_get:xchain.contract.sdk.QueryBlockRequest.height)
  return height_;
}
inline void QueryBlockRequest::set_height(::google::protobuf::int64 value) {
  
  height_ = value;
  // @@protoc_insertion_point(field_set:xchain.contract.sdk.QueryBlockRequest.height)
}
