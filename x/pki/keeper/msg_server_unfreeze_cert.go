...
func (k msgServer) UnfreezeCert(goCtx context.Context, msg *types.MsgUnfreezeCert) (*types.MsgUnfreezeCertResponse, error) {
	...
	return &types.MsgUnfreezeCertResponse{}, nil
}
