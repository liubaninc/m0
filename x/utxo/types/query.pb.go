...
type TamperingRequest struct {
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
	Amount  string `protobuf:"bytes,2,opt,name=amount,proto3" json:"amount,omitempty"`
}

func (m *TamperingRequest) Reset()         { *m = TamperingRequest{} }
func (m *TamperingRequest) String() string { return proto.CompactTextString(m) }
func (*TamperingRequest) ProtoMessage()    {}
func (*TamperingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_089e0fe9ba8c46a3, []int{0}
}
func (m *TamperingRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TamperingRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TamperingRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *TamperingRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TamperingRequest.Merge(m, src)
}
func (m *TamperingRequest) XXX_Size() int {
	return m.Size()
}
func (m *TamperingRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_TamperingRequest.DiscardUnknown(m)
}

var xxx_messageInfo_TamperingRequest proto.InternalMessageInfo

func (m *TamperingRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func (m *TamperingRequest) GetAmount() string {
	if m != nil {
		return m.Amount
	}
	return ""
...
type TamperingResponse struct {
	Outs []*Input `protobuf:"bytes,1,rep,name=outs,proto3" json:"outs,omitempty"`
}

func (m *TamperingResponse) Reset()         { *m = TamperingResponse{} }
func (m *TamperingResponse) String() string { return proto.CompactTextString(m) }
func (*TamperingResponse) ProtoMessage()    {}
func (*TamperingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_089e0fe9ba8c46a3, []int{1}
}
func (m *TamperingResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TamperingResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TamperingResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TamperingResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TamperingResponse.Merge(m, src)
}
func (m *TamperingResponse) XXX_Size() int {
	return m.Size()
}
func (m *TamperingResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_TamperingResponse.DiscardUnknown(m)
}

var xxx_messageInfo_TamperingResponse proto.InternalMessageInfo

func (m *TamperingResponse) GetOuts() []*Input {
	if m != nil {
		return m.Outs
	}
	return nil
...
func (*QueryAllInputRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_089e0fe9ba8c46a3, []int{8}
}
...
func (*QueryAllInputResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_089e0fe9ba8c46a3, []int{9}
}
...
func init() {
	proto.RegisterType((*TamperingRequest)(nil), "liubaninc.m0.utxo.TamperingRequest")
	proto.RegisterType((*TamperingResponse)(nil), "liubaninc.m0.utxo.TamperingResponse")
...
var fileDescriptor_089e0fe9ba8c46a3 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	Tampering(ctx context.Context, in *TamperingRequest, opts ...grpc.CallOption) (*TamperingResponse, error)
}
...
func (c *queryClient) Tampering(ctx context.Context, in *TamperingRequest, opts ...grpc.CallOption) (*TamperingResponse, error) {
	out := new(TamperingResponse)
	err := c.cc.Invoke(ctx, "/liubaninc.m0.utxo.Query/Tampering", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	Tampering(context.Context, *TamperingRequest) (*TamperingResponse, error)
}
...
func (*UnimplementedQueryServer) Tampering(ctx context.Context, req *TamperingRequest) (*TamperingResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Tampering not implemented")
}
...
func _Query_Tampering_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TamperingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).Tampering(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/liubaninc.m0.utxo.Query/Tampering",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).Tampering(ctx, req.(*TamperingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Tampering",
			Handler:    _Query_Tampering_Handler,
		},
	},
...
func (m *TamperingRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *TamperingRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TamperingRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TamperingResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TamperingResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TamperingResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TamperingRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TamperingResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TamperingRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: TamperingRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TamperingRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TamperingResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TamperingResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TamperingResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
