        ...
        <div class="detail-main-assets">
          ...
          <div class="cm-submodule-bg assets-info">
            ...
            <div class="assets-info-row">
              ...
              <div
                class="cm-row-bg cm-text-overflow row-line transferout-row-line"
              >
                {{ address }}
              </div>
            </div>
        ...
        <div class="detail-main-assets">
          ...
          <div class="cm-submodule-bg transferout-publish">
            ...
            <div class="assets-info-row">
              ...
              <div class="row-line add-address-line">
                <a
                  href="javascript:;"
        ...
        <div class="detail-main-assets">
          ...
          <div class="cm-submodule-bg assets-info">
            <div class="assets-info-row">
              ...
              <div class="row-line">
                <template v-if="threshold > 0">双签钱包</template>
                <template v-else>单签钱包</template>
              </div>
            </div>
