        ...
        <div class="wallet-form wallet-form-mesg">
          ...
          <div class="wallet-form-info">
            ...
            <div class="form-info-row">
              ...
              <div class="cm-text-overflow info-row-address">M0</div>
            </div>
            <div class="form-info-row">
              <div class="info-row-name">总发行数量</div>
              <div class="cm-text-overflow info-row-address">100,100,100</div>
            </div>
          </div>
        </div>
        <div class="wallet-btns wl-success-btn back-asset-list">
          <a href="javascript::" class="cm-btn-295px cm-btn-border009F72"
            >返回资产列表</a
          >
        </div>
      </div>
