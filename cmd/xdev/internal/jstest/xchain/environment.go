...
import (
	...
	_ "github.com/liubaninc/m0/x/wasm/xmodel/contract/native"
	_ "github.com/liubaninc/m0/x/wasm/xmodel/contract/wasm/xvm"
)
...
func newEnvironment() (*environment, error) {
	...
	store := newMockStore()
	wasmconfig := &xvm.WasmConfig{
		Driver: "ixvm",
	}
	nativeconfig := &native.NativeConfig{
		Enable: true,
	}
...
func (e *environment) Deploy(args deployArgs) (*ContractResponse, error) {
	...
	descpb := new(xmodel.WasmCodeDesc)
