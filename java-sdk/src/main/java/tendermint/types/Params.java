...
public final class Params {
  ...
  public interface EvidenceParamsOrBuilder extends
     ...
     * </pre>
     *
     * <code>string max_age_duration = 2 [(.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
     */
    java.lang.String getMaxAgeDuration();
    /**
     * <pre>
     * Max age of evidence, in time.
     * It should correspond with an app's "unbonding period" or other similar
  ...
  private static final long serialVersionUID = 0L;
    ...
    private volatile java.lang.Object maxAgeDuration_;
    /**
     * <pre>
     * Max age of evidence, in time.
     * It should correspond with an app's "unbonding period" or other similar
     ...
     * <code>string max_age_duration = 2 [(.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
     */
    public java.lang.String getMaxAgeDuration() {
      java.lang.Object ref = maxAgeDuration_;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (!getMaxAgeDurationBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 2, maxAgeDuration_);
      }
      if (maxBytes_ != 0L) {
    ...
    public int getSerializedSize() {
      ...
      if (!getMaxAgeDurationBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, maxAgeDuration_);
      }
      if (maxBytes_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(tendermint.types.Params.EvidenceParams other) {
        ...
        if (!other.getMaxAgeDuration().isEmpty()) {
          maxAgeDuration_ = other.maxAgeDuration_;
          onChanged();
        }
        if (other.getMaxBytes() != 0L) {
          setMaxBytes(other.getMaxBytes());
      ...
      private java.lang.Object maxAgeDuration_ = "";
      /**
       * <pre>
       * Max age of evidence, in time.
       * It should correspond with an app's "unbonding period" or other similar
    ...
    throw new NullPointerException();
      ...
      public Builder clearMaxAgeDuration() {
        ...
        maxAgeDuration_ = getDefaultInstance().getMaxAgeDuration();
        onChanged();
        return this;
      }
      /**
       ...
       * <code>string max_age_duration = 2 [(.gogoproto.nullable) = false, (.gogoproto.stdduration) = true];</code>
       */
      public Builder setMaxAgeDurationBytes(
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "int.types\032\024gogoproto/gogo.proto\"\363\001\n\017Cons" +
      "ensusParams\0222\n\005block\030\001 \001(\0132\035.tendermint." +
      "types.BlockParamsB\004\310\336\037\000\0228\n\010evidence\030\002 \001(" +
      "\0132 .tendermint.types.EvidenceParamsB\004\310\336\037" +
      "\000\022:\n\tvalidator\030\003 \001(\0132!.tendermint.types." +
      "ValidatorParamsB\004\310\336\037\000\0226\n\007version\030\004 \001(\0132\037" +
      ".tendermint.types.VersionParamsB\004\310\336\037\000\"G\n" +
      "\013BlockParams\022\021\n\tmax_bytes\030\001 \001(\003\022\017\n\007max_g" +
      "as\030\002 \001(\003\022\024\n\014time_iota_ms\030\003 \001(\003\"c\n\016Eviden" +
      "ceParams\022\032\n\022max_age_num_blocks\030\001 \001(\003\022\"\n\020" +
      "max_age_duration\030\002 \001(\tB\010\310\336\037\000\230\337\037\001\022\021\n\tmax_" +
      "bytes\030\003 \001(\003\"2\n\017ValidatorParams\022\025\n\rpub_ke" +
      "y_types\030\001 \003(\t:\010\270\240\037\001\350\240\037\001\".\n\rVersionParams" +
      "\022\023\n\013app_version\030\001 \001(\004:\010\270\240\037\001\350\240\037\001\">\n\014Hashe" +
      "dParams\022\027\n\017block_max_bytes\030\001 \001(\003\022\025\n\rbloc" +
      "k_max_gas\030\002 \001(\003B=Z7github.com/tendermint" +
      "/tendermint/proto/tendermint/types\250\342\036\001b\006" +
      "proto3"
    };
