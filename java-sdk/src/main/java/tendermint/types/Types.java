...
public final class Types {
  ...
  public interface BlockIDOrBuilder extends
    ...
    /**
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
    boolean hasParts();
    /**
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
    tendermint.types.Types.PartSetHeader getParts();
    /**
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
    tendermint.types.Types.PartSetHeaderOrBuilder getPartsOrBuilder();
  }
  /**
   * <pre>
   * BlockID
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              parts_ = input.readMessage(tendermint.types.Types.PartSetHeader.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    private tendermint.types.Types.PartSetHeader parts_;
    /**
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
     ...
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
    public tendermint.types.Types.PartSetHeader getParts() {
      return parts_ == null ? tendermint.types.Types.PartSetHeader.getDefaultInstance() : parts_;
    }
    /**
     * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
     */
    public tendermint.types.Types.PartSetHeaderOrBuilder getPartsOrBuilder() {
      return getParts();
    }
    ...
    throw new NullPointerException();
      ...
      private tendermint.types.Types.PartSetHeader parts_;
      private com.google.protobuf.SingleFieldBuilderV3<
          tendermint.types.Types.PartSetHeader, tendermint.types.Types.PartSetHeader.Builder, tendermint.types.Types.PartSetHeaderOrBuilder> partsBuilder_;
      /**
       * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
       */
      public boolean hasParts() {
       ...
       * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
       */
      public Builder setParts(tendermint.types.Types.PartSetHeader value) {
        if (partsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
       */
      public Builder mergeParts(tendermint.types.Types.PartSetHeader value) {
        if (partsBuilder_ == null) {
          if (parts_ != null) {
            parts_ =
              tendermint.types.Types.PartSetHeader.newBuilder(parts_).mergeFrom(value).buildPartial();
          } else {
            parts_ = value;
          }
          onChanged();
       ...
       * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
       */
      public tendermint.types.Types.PartSetHeader.Builder getPartsBuilder() {
      ...
      public tendermint.types.Types.PartSetHeaderOrBuilder getPartsOrBuilder() {
        if (partsBuilder_ != null) {
          ...
          return parts_ == null ?
              tendermint.types.Types.PartSetHeader.getDefaultInstance() : parts_;
        }
      }
      /**
       * <code>.tendermint.types.PartSetHeader parts = 2 [(.gogoproto.nullable) = false];</code>
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ProofB\004\310\336\037\000\"M\n\007BlockID\022\014\n\004hash\030\001 \001(\014\0224\n\005" +
      "parts\030\002 \001(\0132\037.tendermint.types.PartSetHe" +
      "aderB\004\310\336\037\000\"\263\003\n\006Header\0224\n\007version\030\001 \001(\0132\035" +
      ".tendermint.version.ConsensusB\004\310\336\037\000\022\035\n\010c" +
      "hain_id\030\002 \001(\tB\013\342\336\037\007ChainID\022\016\n\006height\030\003 \001" +
      "(\003\0222\n\004time\030\004 \001(\0132\032.google.protobuf.Times" +
      "tampB\010\310\336\037\000\220\337\037\001\0226\n\rlast_block_id\030\005 \001(\0132\031." +
      "tendermint.types.BlockIDB\004\310\336\037\000\022\030\n\020last_c" +
      "ommit_hash\030\006 \001(\014\022\021\n\tdata_hash\030\007 \001(\014\022\027\n\017v" +
      "alidators_hash\030\010 \001(\014\022\034\n\024next_validators_" +
      "hash\030\t \001(\014\022\026\n\016consensus_hash\030\n \001(\014\022\020\n\010ap" +
      "p_hash\030\013 \001(\014\022\031\n\021last_results_hash\030\014 \001(\014\022" +
      "\025\n\revidence_hash\030\r \001(\014\022\030\n\020proposer_addre" +
      "ss\030\016 \001(\014\"\023\n\004Data\022\013\n\003txs\030\001 \003(\014\"\222\002\n\004Vote\022-" +
      "\n\004type\030\001 \001(\0162\037.tendermint.types.SignedMs" +
      "gType\022\016\n\006height\030\002 \001(\003\022\r\n\005round\030\003 \001(\005\022<\n\010" +
      "block_id\030\004 \001(\0132\031.tendermint.types.BlockI" +
      "DB\017\310\336\037\000\342\336\037\007BlockID\0227\n\ttimestamp\030\005 \001(\0132\032." +
      "google.protobuf.TimestampB\010\310\336\037\000\220\337\037\001\022\031\n\021v" +
      "alidator_address\030\006 \001(\014\022\027\n\017validator_inde" +
      "x\030\007 \001(\005\022\021\n\tsignature\030\010 \001(\014\"\234\001\n\006Commit\022\016\n" +
      "\006height\030\001 \001(\003\022\r\n\005round\030\002 \001(\005\022<\n\010block_id" +
      "\030\003 \001(\0132\031.tendermint.types.BlockIDB\017\310\336\037\000\342" +
      "\336\037\007BlockID\0225\n\nsignatures\030\004 \003(\0132\033.tenderm" +
      "int.types.CommitSigB\004\310\336\037\000\"\250\001\n\tCommitSig\022" +
      "4\n\rblock_id_flag\030\001 \001(\0162\035.tendermint.type" +
      "s.BlockIDFlag\022\031\n\021validator_address\030\002 \001(\014" +
      "\0227\n\ttimestamp\030\003 \001(\0132\032.google.protobuf.Ti" +
      "mestampB\010\310\336\037\000\220\337\037\001\022\021\n\tsignature\030\004 \001(\014\"\365\001\n" +
      "\010Proposal\022-\n\004type\030\001 \001(\0162\037.tendermint.typ" +
      "es.SignedMsgType\022\016\n\006height\030\002 \001(\003\022\r\n\005roun" +
      "d\030\003 \001(\005\022\021\n\tpol_round\030\004 \001(\005\022<\n\010block_id\030\005" +
      " \001(\0132\031.tendermint.types.BlockIDB\017\342\336\037\007Blo" +
      "ckID\310\336\037\000\0227\n\ttimestamp\030\006 \001(\0132\032.google.pro" +
      "tobuf.TimestampB\010\310\336\037\000\220\337\037\001\022\021\n\tsignature\030\007" +
      " \001(\014\"b\n\014SignedHeader\022(\n\006header\030\001 \001(\0132\030.t" +
      "endermint.types.Header\022(\n\006commit\030\002 \001(\0132\030" +
      ".tendermint.types.Commit\"z\n\nLightBlock\0225" +
      "\n\rsigned_header\030\001 \001(\0132\036.tendermint.types" +
      ".SignedHeader\0225\n\rvalidator_set\030\002 \001(\0132\036.t" +
      "endermint.types.ValidatorSet\"\236\001\n\tBlockMe" +
      "ta\022<\n\010block_id\030\001 \001(\0132\031.tendermint.types." +
      "BlockIDB\017\342\336\037\007BlockID\310\336\037\000\022\022\n\nblock_size\030\002" +
      " \001(\003\022.\n\006header\030\003 \001(\0132\030.tendermint.types." +
      "HeaderB\004\310\336\037\000\022\017\n\007num_txs\030\004 \001(\003\"S\n\007TxProof" +
      "\022\021\n\troot_hash\030\001 \001(\014\022\014\n\004data\030\002 \001(\014\022\'\n\005pro" +
      "of\030\003 \001(\0132\030.tendermint.crypto.Proof*\327\001\n\013B" +
      "lockIDFlag\0221\n\025BLOCK_ID_FLAG_UNKNOWN\020\000\032\026\212" +
      "\235 \022BlockIDFlagUnknown\022/\n\024BLOCK_ID_FLAG_A" +
      "BSENT\020\001\032\025\212\235 \021BlockIDFlagAbsent\022/\n\024BLOCK_" +
      "ID_FLAG_COMMIT\020\002\032\025\212\235 \021BlockIDFlagCommit\022" +
      ")\n\021BLOCK_ID_FLAG_NIL\020\003\032\022\212\235 \016BlockIDFlagN" +
      "il\032\010\250\244\036\001\210\243\036\000*\327\001\n\rSignedMsgType\022,\n\027SIGNED" +
      "_MSG_TYPE_UNKNOWN\020\000\032\017\212\235 \013UnknownType\022,\n\027" +
      "SIGNED_MSG_TYPE_PREVOTE\020\001\032\017\212\235 \013PrevoteTy" +
      "pe\0220\n\031SIGNED_MSG_TYPE_PRECOMMIT\020\002\032\021\212\235 \rP" +
      "recommitType\022.\n\030SIGNED_MSG_TYPE_PROPOSAL" +
      "\020 \032\020\212\235 \014ProposalType\032\010\250\244\036\001\210\243\036\000B9Z7github" +
